...
function scene:create(event)
  ...
  -- Crio o título
  local logo = display.newText(sceneGroup, "Adventure Sucess", display.contentCenterX, 175, native.systemFont, 100)
  logo:setFillColor(color.preto.r, color.preto.g, color.preto.b)

  -- Coloco o nome dos autores
  local txtJeidsan = display.newText(sceneGroup, "Elias Rocha de Aquino", display.contentCenterX, 300, native.systemFont, 50)
