...
local function createBackground(backGroup)
	...
	background = display.newImageRect(backGroup, "images/backgroundGameOver.png", display.contentWidth, display.contentHeight)
...
local function createInfo(infoGroup)
  ...
  txtScores = display.newText(infoGroup, adjustText(""..composer.getVariable("score")), textWidth, textHeight, native.systemFont, 70)
...
local function loadScores()
	-- Carrego a biblioteca para decodificao os dados
